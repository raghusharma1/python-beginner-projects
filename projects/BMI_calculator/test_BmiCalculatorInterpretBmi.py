...
class Test_BmiCalculatorInterpretBmi:
    ...
    def test_interpret_bmi_for_underweight(self):
        assert interpret_bmi(18.0) == "Your BMI is 18.0, you are underweight."

    @pytest.mark.regression
    def test_interpret_bmi_for_normal_weight(self):
        assert interpret_bmi(24.0) == "Your BMI is 24.0, you have a normal weight."

    @pytest.mark.regression
    def test_interpret_bmi_for_overweight(self):
        assert interpret_bmi(28.0) == "Your BMI is 28.0, you are overweight."

    @pytest.mark.regression
    def test_interpret_bmi_for_obesity_classes(self):
        assert interpret_bmi(32.0) == "Your BMI is 32.0, you are obese (Class I)."
        assert interpret_bmi(38.0) == "Your BMI is 38.0, you are obese (Class II)."
        assert interpret_bmi(42.0) == "Your BMI is 42.0, you are obese (Class III)."
