...
class Test_BmiCalculatorInterpretBmi:
    """
    Test class for testing the interpret_bmi function from BMI_calculator module
    """

    def test_interpret_bmi_for_underweight(self):
        """
        Test case for verifying that the function correctly identifies and classifies a BMI value that falls under the underweight category
        """
        bmi = 17.0
        expected_result = f"Your BMI is {bmi}, you are underweight."
        assert interpret_bmi(bmi) == expected_result

    def test_interpret_bmi_for_normal_weight(self):
        """
        Test case for verifying that the function correctly identifies and classifies a BMI value that falls under the normal weight category
        """
        bmi = 22.0
        expected_result = f"Your BMI is {bmi}, you have a normal weight."
        assert interpret_bmi(bmi) == expected_result

    def test_interpret_bmi_for_overweight(self):
        """
        Test case for verifying that the function correctly identifies and classifies a BMI value that falls under the overweight category
        """
        bmi = 28.0
        expected_result = f"Your BMI is {bmi}, you are overweight."
        assert interpret_bmi(bmi) == expected_result

    def test_interpret_bmi_for_obesity_classes(self):
        """
        Test case for verifying that the function correctly identifies and classifies a BMI value that falls under the various obesity classes
        """
        bmi_class_I = 32.0
        bmi_class_II = 35.0
        bmi_class_III = 40.0
        expected_result_class_I = f"Your BMI is {bmi_class_I}, you are obese (Class I)."
        expected_result_class_II = f"Your BMI is {bmi_class_II}, you are obese (Class II)."
        expected_result_class_III = f"Your BMI is {bmi_class_III}, you are obese (Class III)."

        assert interpret_bmi(bmi_class_I) == expected_result_class_I
        assert interpret_bmi(bmi_class_II) == expected_result_class_II
        assert interpret_bmi(bmi_class_III) == expected_result_class_III

    def test_interpret_bmi_for_invalid_input(self):
        """
        Test case for verifying that the function correctly handles invalid input
        """
        bmi = None
