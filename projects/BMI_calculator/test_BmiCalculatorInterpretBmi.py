...
class Test_BmiCalculatorInterpretBmi:
    ...
    def test_interpret_bmi_for_underweight(self):
        """
        This test verifies that the function correctly identifies and classifies a BMI value that falls under the underweight category.
        """
        bmi = 17.5
    ...
    def test_interpret_bmi_for_normal_weight(self):
        """
        This test verifies that the function correctly identifies and classifies a BMI value that falls under the normal weight category.
        """
        bmi = 22.5
        result = interpret_bmi(bmi)
    ...
    def test_interpret_bmi_for_overweight(self):
        """
        This test verifies that the function correctly identifies and classifies a BMI value that falls under the overweight category.
        """
        bmi = 28.5
        result = interpret_bmi(bmi)
    ...
    def test_interpret_bmi_for_obesity_classes(self):
        """
        This test verifies that the function correctly identifies and classifies a BMI value that falls under the various obesity classes.
        """
        bmi_class1 = 32.5
        bmi_class2 = 36.5
        bmi_class3 = 42.5
        result_class1 = interpret_bmi(bmi_class1)
        result_class2 = interpret_bmi(bmi_class2)
        result_class3 = interpret_bmi(bmi_class3)
        assert result_class1 == f"Your BMI is {bmi_class1}, you are obese (Class I)."
        assert result_class2 == f"Your BMI is {bmi_class2}, you are obese (Class II)."
        assert result_class3 == f"Your BMI is {bmi_class3}, you are obese (Class III)."

    def test_interpret_bmi_for_invalid_input(self):
        """
        This test verifies that the function correctly handles invalid input.
        """
        bmi = None
        result = interpret_bmi(bmi)
