...
class Test_BmiCalculatorInterpretBmi:
    ...
    def test_interpret_bmi_for_underweight(self):
        ...
        assert result == f"Your BMI is {bmi}, you are underweight.", "Failed to interpret BMI for underweight category"

    def test_interpret_bmi_for_normal_weight(self):
        bmi = 23.5
        result = interpret_bmi(bmi)
        assert result == f"Your BMI is {bmi}, you have a normal weight.", "Failed to interpret BMI for normal weight category"

    def test_interpret_bmi_for_overweight(self):
        bmi = 27.5
        result = interpret_bmi(bmi)
        assert result == f"Your BMI is {bmi}, you are overweight.", "Failed to interpret BMI for overweight category"

    def test_interpret_bmi_for_obesity_classes(self):
        bmi_class1 = 33.5
        result_class1 = interpret_bmi(bmi_class1)
        assert result_class1 == f"Your BMI is {bmi_class1}, you are obese (Class I).", "Failed to interpret BMI for obesity class I"

        bmi_class2 = 37.5
        result_class2 = interpret_bmi(bmi_class2)
        assert result_class2 == f"Your BMI is {bmi_class2}, you are obese (Class II).", "Failed to interpret BMI for obesity class II"

        bmi_class3 = 41.5
        result_class3 = interpret_bmi(bmi_class3)
        assert result_class3 == f"Your BMI is {bmi_class3}, you are obese (Class III).", "Failed to interpret BMI for obesity class III"
