...
class Test_BmiCalculatorInterpretBmi:
    ...
    def test_bmi_obese_class_i(self):
        bmi_value = 32.0
        result = interpret_bmi(bmi_value)
        assert result == f"Your BMI is {bmi_value}, you are obese (Class I)."
    ...
    def test_bmi_obese_class_ii(self):
        bmi_value = 37.5
        result = interpret_bmi(bmi_value)
        assert result == f"Your BMI is {bmi_value}, you are obese (Class II)."
    ...
    def test_bmi_obese_class_iii(self):
        bmi_value = 42.0
        result = interpret_bmi(bmi_value)
        assert result == f"Your BMI is {bmi_value}, you are obese (Class III)."
