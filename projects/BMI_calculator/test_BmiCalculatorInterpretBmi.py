...
# ********RoostGPT********
import pytest
from BMI_calculator import interpret_bmi  # Corrected the import path
...
class Test_BmiCalculatorInterpretBmi:
    ...
    def test_bmi_underweight(self):
        # Arrange
        bmi_value = 17.5  # A BMI less than 18.5 categorizes as underweight
        
        # Act
        result = interpret_bmi(bmi_value)
        
        # Assert
        assert result == f"Your BMI is {bmi_value}, you are underweight.", f"Test failed, got: {result}"
    
    @pytest.mark.valid
    @pytest.mark.positive
    def test_bmi_normal_weight(self):
        # Arrange
        bmi_value = 22.0  # A BMI between 18.5 and 24.9 is normal weight
        
        # Act
        result = interpret_bmi(bmi_value)
        
        # Assert
        assert result == f"Your BMI is {bmi_value}, you have a normal weight.", f"Test failed, got: {result}"

    @pytest.mark.valid
    @pytest.mark.positive
    def test_bmi_overweight(self):
        # Arrange
        bmi_value = 27.0  # A BMI between 25.0 and 29.9 is overweight
        
        # Act
        result = interpret_bmi(bmi_value)
        
        # Assert
        assert result == f"Your BMI is {bmi_value}, you are overweight.", f"Test failed, got: {result}"

    @pytest.mark.valid
    @pytest.mark.positive
    def test_bmi_obese_class_i(self):
        # Arrange
        bmi_value = 32.0  # A BMI between 30.0 and 34.9 is obese (Class I)
        
        # Act
        result = interpret_bmi(bmi_value)
        
        # Assert
        assert result == f"Your BMI is {bmi_value}, you are obese (Class I).", f"Test failed, got: {result}"

    @pytest.mark.valid
    @pytest.mark.positive
    def test_bmi_obese_class_ii(self):
        # Arrange
        bmi_value = 37.5  # A BMI between 35.0 and 39.9 is obese (Class II)
        
        # Act
        result = interpret_bmi(bmi_value)
        
        # Assert
        assert result == f"Your BMI is {bmi_value}, you are obese (Class II).", f"Test failed, got: {result}"
    
    @pytest.mark.valid
    @pytest.mark.positive
    def test_bmi_obese_class_iii(self):
        # Arrange
        bmi_value = 42.0  # A BMI of 40.0 or higher is obese (Class III)
        
        # Act
        result = interpret_bmi(bmi_value)
        
        # Assert
        assert result == f"Your BMI is {bmi_value}, you are obese (Class III).", f"Test failed, got: {result}"
    ...
    def test_bmi_none_input(self):
        ...
        # Assert
        assert result == "Invalid input. Height should be greater than 0.", f"Test failed, got: {result}"
    
# Removed unnecessary if __name__ == '__main__': part as it's not required for pytest
