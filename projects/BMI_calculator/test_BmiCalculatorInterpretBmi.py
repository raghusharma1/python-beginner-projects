...
# ********RoostGPT********
import pytest
# Correcting the import path according to the given directory structure
from BMI_calculator.BMI_calculator import interpret_bmi

class Test_BmiCalculatorInterpretBmi:
    # Using `pytest.mark.parametrize` to effectively cover multiple test cases
    @pytest.mark.parametrize("bmi_value, expected_result", [
        (17.5, "Your BMI is 17.5, you are underweight."),
        (22.0, "Your BMI is 22.0, you have a normal weight."),
        (27.5, "Your BMI is 27.5, you are overweight."),
        (32.0, "Your BMI is 32.0, you are obese (Class I)."),
        (37.0, "Your BMI is 37.0, you are obese (Class II)."),
        (42.0, "Your BMI is 42.0, you are obese (Class III).")
    ])
    def test_bmi_valid_inputs(self, bmi_value, expected_result):
        # Arrange & Act are combined in parameterize
        # Assert
        assert interpret_bmi(bmi_value) == expected_result
...
# The main block is not necessary for pytest and should be omitted to prevent script execution issues during test discovery.
