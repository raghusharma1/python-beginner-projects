...
class Test_BmiCalculatorReferenceChart:
    ...
    def test_reference_chart_valid_file(self):
        ...
        with patch('builtins.open', m):
            with patch('csv.reader', return_value=csv.reader(StringIO(mock_data))):
                with patch('tabulate.tabulate', return_value='tabulated data'):
                    reference_chart()
                    m.assert_called_once_with('bmi.csv')
    ...
    def test_reference_chart_empty_file(self):
        ...
        with patch('builtins.open', m):
            with patch('csv.reader', return_value=csv.reader(StringIO(''))):
                with patch('tabulate.tabulate', return_value='tabulated data'):
                    reference_chart()
                    m.assert_called_once_with('bmi.csv')
                    tabulate.tabulate.assert_called_once()
