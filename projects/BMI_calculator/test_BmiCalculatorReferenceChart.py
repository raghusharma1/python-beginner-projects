...
class Test_BmiCalculatorReferenceChart:
    ...
    def test_reference_chart_valid_file(self, tmpdir):
        ...
        assert output == tabulate.tabulate([["18.5", "60", "Normal"], ["25", "75", "Overweight"]], headers=["bmi", "weight", "status"], tablefmt="fancy_grid")
    ...
    def test_reference_chart_empty_file(self, tmpdir):
        ...
        os.chdir(tmpdir)
        output = reference_chart()
        assert output == tabulate.tabulate([], headers=[], tablefmt="fancy_grid")
