...
class Test_BmiCalculatorMain:
    ...
    def test_normal_weight(self, monkeypatch):
        """
        Test for normal weight range
        """
        # Arrange
        monkeypatch.setattr('builtins.input', lambda _: "1.75")
        monkeypatch.setattr('BMI_calculator.BMI_calculator.calculate_bmi', lambda a,b: 22.86)
    ...
    @pytest.mark.regression
    def test_underweight(self, monkeypatch):
        """
        Test for underweight range
        """
        # Arrange
        monkeypatch.setattr('builtins.input', lambda _: "1.8")
        monkeypatch.setattr('BMI_calculator.BMI_calculator.calculate_bmi', lambda a,b: 15.43)
    ...
    @pytest.mark.regression
    def test_overweight(self, monkeypatch):
        """
        Test for overweight range
        """
        # Arrange
        monkeypatch.setattr('builtins.input', lambda _: "1.7")
        monkeypatch.setattr('BMI_calculator.BMI_calculator.calculate_bmi', lambda a,b: 27.68)
    ...
    @pytest.mark.regression
    def test_obese(self, monkeypatch):
        """
        Test for obese range
        """
        # Arrange
        monkeypatch.setattr('builtins.input', lambda _: "1.6")
        monkeypatch.setattr('BMI_calculator.BMI_calculator.calculate_bmi', lambda a,b: 35.16)
