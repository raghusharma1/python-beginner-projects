...
class Test_BmiCalculatorMain:
    ...
    def test_interpret_bmi_normal(self):
        ...
        # Assert
        assert "normal weight" in result.lower()
    ...
    def test_main_nonnumerical_inputs(self, monkeypatch):
        ...
        # Assert
        assert result == "Invalid input. Please enter numerical values for height and weight."

    @pytest.mark.regression
    def test_reference_chart_display(self, monkeypatch):
        # Arrange
        monkeypatch.setattr('builtins.open', lambda _: csv.reader([["BMI", "Interpretation"], [18.5, "Underweight"]]))
