...
roost_feedback [9/11/2024, 5:29:50 PM]:Please print in each function the text provided below **Function location** in the prompt
"""
...
class Test_MainDisplayScoreboard:
    ...
    def test_display_scoreboard_equal_scores(self, monkeypatch):
        # Arrange
    ...
    @pytest.mark.regression
    def test_display_scoreboard_max_scores(self, monkeypatch):
        # Arrange
