...
# The correct import statement should specify the full path from the project's root. 
# Assuming the main.py is within a folder named HandCricket and the function to be tested is display_scoreboard
...
class Test_MainDisplayScoreboard:
    ...
    def test_display_scoreboard_positive_scores(self):
        # Using patch to mock the print function to verify the outputs without actual printing
        with patch('builtins.print') as mocked_print:
            display_scoreboard(50, 75, 5)
            mocked_print.assert_called_with("Player 2: 75 runs")
            # Ensuring the correct order and values are printed, including the correct over number
    ...
    def test_display_scoreboard_zero_scores(self):
        with patch('builtins.print') as mocked_print:
            ...
            # When over is 0, the output should correctly state "Over 1:"
    ...
    def test_display_scoreboard_high_over_number(self):
        with patch('builtins.print') as mocked_print:
            ...
            # Test for high over numbers, ensuring correct increment and print
    ...
    def test_display_scoreboard_negative_scores(self):
        with patch('builtins.print') as mocked_print:
            ...
            # Testing with negative scores to ensure correct handling and output
            assert mocked_print.call_args_list[1].args[0] == "Over 4:"
            assert mocked_print.call_args_list[2].args[0] == "Player 1: -10 runs"

# The main execution block is not needed in the pytest file as pytest handles the test execution.
# Removed if __name__ == '__main__': main() as it is not appropriate in this context.
