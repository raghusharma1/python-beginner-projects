...
# Assuming the function who_won is correctly defined in a module named main.py
# Importing it as per the given instruction to use exact names without any path alteration
