...
# Assuming the function who_won is correctly defined in `main.py` under the `HandCricket` directory
# and the directory structure is as follows: projects->HandCricket->main.py->who_won
# Correct import path based on the given directory structure
...
class Test_MainWhoWon:
    ...
    def test_player1_wins(self, monkeypatch):
        # Test to ensure that the function correctly identifies when player 1 wins
        player1_score = 100
        player2_score = 50
        expected_output = "Player 1 won"

        # Using monkeypatch to capture the output from print statements
    ...
    def test_player2_wins(self, monkeypatch):
        # Test to ensure that the function correctly identifies when player 2 wins
        player1_score = 30
        player2_score = 80
    ...
    def test_draw_game(self, monkeypatch):
        # Test to ensure that the function correctly identifies a draw
        player1_score = 70
        player2_score = 70
    ...
    def test_large_scores(self, monkeypatch):
        # Test to ensure that the function handles large integer inputs correctly
        player1_score = 10**12
