...
# Assuming that toss() function is now inside this script for testing purposes
def toss():
    print("Toss time!")
...
# Test cases for the toss function
@pytest.mark.valid
...
def test_user_inputs_invalid_choice():
    with patch('builtins.input', return_value="3"):
        # Using try-except to handle ValueError for unexpected input
        try:
            result = toss()
            assert result is None, "The function should handle invalid inputs gracefully"
        except ValueError as e:
            assert str(e) == "Invalid choice", "The function should raise an error message for invalid choice"
