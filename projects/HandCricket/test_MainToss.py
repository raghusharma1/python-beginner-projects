...
class Test_MainToss:
    ...
    def test_correct_user_choice_heads(self):
        with patch('HandCricket.main.input', return_value='1'), patch('random.randint', return_value=1):
            assert toss() == 1

    def test_correct_user_choice_tails(self):
        with patch('HandCricket.main.input', return_value='2'), patch('random.randint', return_value=2):
            assert toss() == 2

    def test_incorrect_user_choice_heads(self):
        with patch('HandCricket.main.input', return_value='2'), patch('random.randint', return_value=1):
            assert toss() == 2

    def test_incorrect_user_choice_tails(self):
