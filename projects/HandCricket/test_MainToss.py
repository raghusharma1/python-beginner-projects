...
# projects->HandCricket->main.py->toss
# projects->HandCricket->test_MainToss.py
# Correcting the import statement to reflect the actual file structure and module name
...
class Test_MainToss:
    ...
    def test_player_one_wins_with_correct_guess(self):
        # Mocking input to simulate user choosing '1' and random.randint to return '1' (Heads)
    ...
    def test_player_two_wins_with_incorrect_guess(self):
        # Mocking input to simulate user choosing '2' and random.randint to return '1' (Heads)
    ...
    def test_output_correct_announcement(self):
        # Mocking input and random outcome, and capturing output to verify correct announcement
