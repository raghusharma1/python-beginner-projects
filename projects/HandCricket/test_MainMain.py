...
def display_scoreboard(player1_score, player2_score, over):
    print(f"After Over {over + 1}:")
    print(f"Player 1 Score: {player1_score}")
    print(f"Player 2 Score: {player2_score}")

def user_turn(player_score, player_wickets, player_type, over):
    # Example implementation
    runs = random.randint(0, 6)
    wickets = random.choice([0, 1])  # 0 or 1 wicket per ball
    player_score += runs
    player_wickets -= wickets
    return player_score, max(0, player_wickets)
