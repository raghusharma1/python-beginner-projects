...
class Test_MainPlayGame:
    ...
    def test_play_game_basic_functionality(self, monkeypatch):
    ...
    def test_play_game_max_overs(self, monkeypatch):
        monkeypatch.setattr('random.randint', lambda x, y: 1)
        monkeypatch.setattr('builtins.input', lambda _: '1')
    ...
    @pytest.mark.performance
    def test_play_game_min_overs(self, monkeypatch):
        monkeypatch.setattr('random.randint', lambda x, y: 1)
        monkeypatch.setattr('builtins.input', lambda _: '1')
        player1_score, player2_score = play_game(1, '1', '2')
        assert isinstance(player1_score, int)
    ...
    def test_play_game_error_handling(self, monkeypatch):
        monkeypatch.setattr('random.randint', lambda x, y: 1)
        monkeypatch.setattr('builtins.input', lambda _: '3')  # Invalid choice
