...
class Test_MainPlayGame:
    ...
    def test_play_game_with_one_over(self, monkeypatch):
        inputs = iter(['1', '1', '2', '1', '2', '3', '1', '4', '1', '5', '1', '6'])
    ...
    def test_play_game_player_roles_switched(self, monkeypatch):
        inputs = iter(['2', '1', '1', '2', '2', '3', '2', '4', '2', '5', '2', '6'])
        monkeypatch.setattr('builtins.input', lambda _: next(inputs))
        result = play_game(1, "2", "1")
        assert isinstance(result, tuple)
        assert len(result) == 2
    ...
    def test_play_game_with_maximum_overs(self, monkeypatch):
        inputs = iter(['1'] * 300)  # Assuming 50 overs and 6 balls each, both players batting and bowling
        monkeypatch.setattr('builtins.input', lambda _: next(inputs))
...
# Note: The test cases assume that the user_turn and display_scoreboard functions have been defined correctly in the same module as play_game.
