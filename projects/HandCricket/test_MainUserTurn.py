...
# Assuming 'main.py' has been correctly placed in the directory 'HandCricket' and is part of a package.
# The import path below assumes that 'HandCricket' is a package and 'main' is a module in it.
