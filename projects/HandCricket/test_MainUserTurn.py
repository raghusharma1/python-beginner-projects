...
# Define the user_turn function to simulate the game logic
def user_turn(player_score, player_wickets, player_choice, over):
    ...
    while balls < 6 and player_wickets > 0:
        if player_choice == "1":
            # Simulate user input for batting
            player_runs = random.randint(1, 6)
            opponent_runs = random.randint(1, 6)
        else:
            # Simulate user input for bowling
            opponent_choice = "1"  # Assume opponent chooses to bat
            player_runs = random.randint(1, 6)
            opponent_runs = random.randint(1, 6)
...
# Define the test cases using the pytest framework
