...
# Mocking the user_turn function as it is not provided, assuming its behavior based on the test cases
...
class Test_MainUserTurn:
    ...
    def test_player_scores_runs_while_batting(self):
        with patch('builtins.input', side_effect=['1', '2', '3', '4', '5', '6']), \
            ...
            assert final_score == sum([2, 3, 4, 5, 6, 1]), "Score should be sum of all runs when not out"
