...
class Test_CalculateJudgeLeapYear:
    ...
    def test_leap_year_multiple_of_400(self):
        ...
        # Assert
        assert result == True, "2000 is a multiple of 400 and should be a leap year, thus should return True"
    ...
    def test_with_minimum_boundary_year(self):
        ...
        # Assert
        assert result == False, "Year 1 is not a leap year and should return False"
