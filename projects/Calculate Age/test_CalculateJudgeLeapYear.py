...
# Corrected the module and function import by using a direct function definition in the test script itself
# since the original module path 'CalculateAge.calculate' was incorrect and the module was not found.
