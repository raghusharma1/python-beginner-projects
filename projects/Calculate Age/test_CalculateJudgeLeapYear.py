...
class Test_CalculateJudgeLeapYear:
    ...
    def test_common_leap_year(self):
        assert isleap(2020) == True, "Year 2020 should be identified as a leap year"

    @pytest.mark.valid
    @pytest.mark.negative
    def test_non_leap_year(self):
        assert isleap(2019) == False, "Year 2019 should be identified as a non-leap year"

    @pytest.mark.valid
    @pytest.mark.negative
    def test_century_non_leap_year(self):
        assert isleap(1900) == False, "Year 1900 should be identified as a non-leap year because it is not divisible by 400"

    @pytest.mark.valid
    @pytest.mark.positive
    def test_century_leap_year(self):
        assert isleap(2000) == True, "Year 2000 should be identified as a leap year because it is divisible by 400"
    ...
    def test_current_year_leap_status(self):
        ...
        assert isleap(current_year) == expected_result, f"Current year {current_year} leap year status should be {expected_result}"
